...
//    public final String allowSuffix = ".bmp.jpg.jpeg.png.gif.pdf.doc.zip.rar.gz";
     ...
     * @return
     */
    @RequestMapping(value = "/attachmentsbyajax")
    public String attachmentsbyajax(@RequestParam(required = false, defaultValue = "1") Integer pageIndex,
                              @RequestParam(required = false, defaultValue = "15") Integer pageSize,
                              @RequestParam(required = false) String keywords,
                              Model model, HttpSession session){
        HashMap<String, Object> criteria = new HashMap<>(1);
        ...
        return "admin/attachment/attachments :: attachmentList";
    }
    ...
    public String removeAttachment(@RequestParam("id") Integer attachId,
        ...
        try {
            ...
            if (StringUtils.isBlank(fileUploadResult1.getResponse()) || StringUtils.isBlank(fileUploadResult2.getResponse())) {
